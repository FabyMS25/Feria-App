	...
	<div class="d-flex align-items-center mb-3">
		...
		<div class="ms-auto">
			<a href="#" class="btn btn-theme"><i class="fa fa-plus-circle fa-fw me-1"></i> Create Orders</a>
		</div>
	</div>
		...
		<div class="tab-content p-4">
			<div class="tab-pane fade show active" id="allTab">
				...
				<div class="input-group mb-4">
					...
					<button class="btn btn-default dropdown-toggle rounded-0" type="button" data-bs-toggle="dropdown"><span class="d-none d-md-inline">Payment Status</span><span class="d-inline d-md-none"><i class="fa fa-credit-card"></i></span> &nbsp;</button>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">Action</a>
						<a class="dropdown-item" href="#">Another action</a>
						<a class="dropdown-item" href="#">Something else here</a>
					...
					<button class="btn btn-default dropdown-toggle" type="button" data-bs-toggle="dropdown"><span class="d-none d-md-inline">Fulfillment status</span><span class="d-inline d-md-none"><i class="fa fa-check"></i></span></button>
					...
					<table class="table table-hover text-nowrap">
						...
						<tbody>
							<tr>
								...
								<td>$398.00</td>
								<td class="py-1 align-middle"><span class="badge bg-teal text-teal-800 bg-opacity-25 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle text-teal fs-9px fa-fw me-5px"></i> Paid</span></td>
								<td class="align-middle"><span class="badge bg-gray-100 text-black text-opacity-50 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle text-gray-500 fs-9px fa-fw me-5px"></i> Fulfilled</span></td>
							...
							<tr>
								...
								<td>$195.00</td>
								<td class="py-1 align-middle"><span class="badge bg-orange bg-opacity-20 text-orange px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Pending</span></td>
								<td class="align-middle"><span class="badge bg-yellow bg-opacity-50 text-black text-opacity-50 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle fs-9px fa-fw me-5px"></i> Unfulfilled</span></td>
							...
							<tr>
								...
								<td>$900.00</td>
								<td class="py-1 align-middle"><span class="badge bg-teal text-teal-800 bg-opacity-25 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle text-teal fs-9px fa-fw me-5px"></i> Paid</span></td>
								<td class="align-middle"><span class="badge bg-primary bg-opacity-20 text-primary px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle text-primary text-opacity-80 fs-9px fa-fw me-5px"></i> Ready for pickup</span></td>
								<td class="align-middle">2 items</td>
								<td class="align-middle">Local pickup</td>
							</tr>
							<tr>
								...
								<td>$625.00</td>
								<td class="py-1 align-middle"><span class="badge bg-teal text-teal-800 bg-opacity-25 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle text-teal fs-9px fa-fw me-5px"></i> Paid</span></td>
								<td class="align-middle"><span class="badge bg-primary bg-opacity-20 text-primary px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle text-primary text-opacity-80 fs-9px fa-fw me-5px"></i> Ready for delivery</span></td>
								<td class="align-middle">1 item</td>
								<td class="align-middle">Local pickup</td>
							</tr>
							<tr>
								...
								<td>$195.00</td>
								<td class="py-1 align-middle"><span class="badge bg-gray-100 text-black text-opacity-50 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle text-gray-500 fs-9px fa-fw me-5px"></i> Partially refunded</span></td>
								<td class="align-middle"><span class="badge bg-danger bg-opacity-30 text-black text-opacity-50 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i class="fa fa-circle fs-9px fa-fw me-5px text-danger text-opacity-80"></i> Partially fulfilled</span></td>
								<td class="align-middle">2 items</td>
								<td class="align-middle">Express</td>
							</tr>
							<tr>
